...
init_a = np.array([
    [4.0, -0.5, 2.0],   # m1 (blue)
    [2.0, 2.5, 1.0],    # m2 (black)
    [10.0, 2.0, -1.0],  # m3 (red)
    [7.0, 0.5, -0.5],    # m4 (green)
    [12.0, 1.0, -1.0]   # m5 (magenta)
])
...
plt.title("Distortion Curve - Initialization (a)")
...
ax.set_title(f"Final Clustering (a) - {total_iters} Iterations")
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_zlabel('Z')
ax.legend()
